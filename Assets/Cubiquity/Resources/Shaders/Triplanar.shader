Shader "Triplanar"
{
	...
	// When using Unity 5 on our OS X VM it seems we cannot support eight materials due to a limited number
	// of texture interpolators. Therefore we provide this fallback which supports only four materials.
	SubShader {
		Tags { "RenderType"="Opaque" }
		LOD 200
